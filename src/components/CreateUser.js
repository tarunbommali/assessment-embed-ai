            ...
            <Form autoComplete='off'>
              <div>
                ...
                <Field
                  ...
                  maxLength="20"
                />
                {formik.errors.character_name && <h1 className="text-[#ff4041]"> * {formik.errors.character_name}</h1>}
              </div>
              <br />
              <div>
                ...
                <Field
                  ...
                  maxLength="50"
                />
                {formik.errors.tagline && <h1 className="text-[#ff4041]"> * {formik.errors.tagline}</h1>}
              </div>
              <br />
              <div>
                ...
                <Field
                  ...
                  maxLength="500"
                />
                {formik.errors.description && <h1 className="text-[#ff4041]"> * {formik.errors.description}</h1>}
              </div>
              <br />
              <div>
                ...
                <Field
                  ...
                  maxLength="2048"
                />
                {formik.errors.greeting && <h1 className="text-[#ff4041]"> * {formik.errors.greeting}</h1>}
              </div>
              <br />
              <button type="submit" className='flex-end  bg-[#ffffff] items-end rounded-3xl text-black px-4 py-2 my-3' disabled={formik.isSubmitting}>Create Character</button>
            </Form>
          )}
        </Formik>
      </div>
